...
public class CreateCone /*: ScriptableWizard*/: MonoBehaviour
{

    public int numVertices = 36;
    ...
    public GameObject GenerateCone()
    {
        ...
        if (mesh == null)
        {
            ...
            for (i = 0; i < numVertices; i++)
            {
                ...
                vertices[i] = new Vector3(radiusTop * angleCos, length/2, radiusTop * angleSin);
                vertices[i + numVertices] = new Vector3(radiusBottom * angleCos,-length/2, radiusBottom * angleSin);
        ...
        newCone.GetComponent<MeshCollider>().sharedMesh = mesh;
